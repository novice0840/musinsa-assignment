...
export class ApplicationController {
  ...
  @ApiResponse({ status: 201, description: '지원서가 성공적으로 제출되었습니다.' })
  ...
  @ApiResponse({ status: 200, description: '지원서 목록을 성공적으로 조회했습니다.' })
  findAll() {
  ...
  @ApiResponse({ status: 200, description: '지원서를 성공적으로 조회했습니다.' })
  ...
  @ApiResponse({ status: 200, description: '채용 공고별 지원서 목록을 성공적으로 조회했습니다.' })
